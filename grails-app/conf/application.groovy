...
// Added by the Spring Security Core plugin:
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ff.okta.Seller'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ff.okta.SellerRole'
grails.plugin.springsecurity.authority.className = 'com.ff.okta.Role'
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	[pattern: '/',               access: ['permitAll']],
	[pattern: '/error',          access: ['permitAll']],
...
// Added by the Spring Security Core plugin:
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ff.Seller'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ff.SellerRole'
...
// Added by the Spring Security OAuth2 Google Plugin:
grails.plugin.springsecurity.oauth2.domainClass = 'com.ff.OAuthID'

//always redirect to Okta
